...
Открытие браузера при включении livereload или расшаривании верстки во внешний веб. Также есть возможность задать порт из переменной окружения BROWSERSYNC_PORT. Значение этой переменной переопределить значение, заданное в конфиге.
...
Оцпия инжекта css при лайврелоад. Если вам нужен ижект стилей при пересборке без перезагрузки страницы, то устанвоить эту опцию в true.
