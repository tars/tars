...
└── tars/                   # Таски и хелперы для gulp
    ...
    └── user-tasks/         # Пользовательские вотчеры
...
exampleModule/                              # Пример модуля
    └── assets/                             # Файлы, относящиейся только к данному модулю (файлы любого типа)
