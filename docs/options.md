...
Если вы хотите писать на простом css, то оставьте опцию без изменений или выберете less. Расширение файлов будет соответствовать препроцессору, но содержимое может быть на css.
