...
Если вы ничего не поняли, то сделайте эту опцию такой же, как и <a href="https://github.com/artem-malko/tars/blob/master/docs/options.md#staticfoldername">staticFolderName</a>
...
Имя папки, в которой будет лежать статика проекта.
