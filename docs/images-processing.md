...
Вы можете пропустить теорию и сразу <a href="images-processing.md#%D0%9F%D0%BE%D0%B4%D0%BA%D0%BB%D1%8E%D1%87%D0%B5%D0%BD%D0%B8%D0%B5-%D1%81%D0%BF%D1%80%D0%B0%D0%B9%D1%82%D0%BE%D0%B2">перейти к описанию работы со спрайтами</a>.
...
Миксин `bg-svg` включит в css подключит svg-спрайт в качестве фона, задаст все необходимые смещения и размеры.
...
Находятся в папке assets внутри модуля. Для подключения используется следующий шаблон (для подключения картинки в html, необходимо использовать плейсхолдер <a href="options.md#staticPrefix" target="_blank">%=staticPrefix=%</a>):
