...
* Livereload с помощью browserSync, так же опционально. Также синхронизация между устройствами, опять же с помощью browserSync. Это лучше попробовать самому.
